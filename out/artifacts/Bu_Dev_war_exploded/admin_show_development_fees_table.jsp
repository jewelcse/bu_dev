...
%>
<%@ page import="com.budev.model.Devfees" %>
    ...
    <div id="printData">
        ...
        <table class="table table-hover" id="myTable" border="2px solid black">
            ...
            <tr>
                ...
                <td>
                    <a href="adminFeesTableController?type=development_fee&&status=false&&id=<% out.print(allDevfee.get(i).getId());%> "><input
                            type="submit" class="btn btn-danger" value="Not-Verify"></a>
                    <a href="adminFeesTableController?type=development_fee&&status=true&&id=<% out.print(allDevfee.get(i).getId());%> "><input
                            type="submit" class="btn btn-success" value="Verify"></a>
                </td>
