...
import com.budev.Utility.Util;
import com.budev.parametermappings.SSLCommerzInitResponse;
import com.budev.parametermappings.SSLCommerzValidatorResponse;
...
public class SSLCommerz {
    ...
    boolean orderValidate(String merchantTrnxnId, String merchantTrnxnAmount, String merchantTrnxnCurrency,
        ...
        if (hash_verified) {
            ...
            String EncodedValID = URLEncoder.encode(requestParameters.get("val_id"), StandardCharsets.UTF_8.displayName());
            String EncodedStoreID = URLEncoder.encode(this.storeId, StandardCharsets.UTF_8.displayName());
            String EncodedStorePassword = URLEncoder.encode(this.storePass, StandardCharsets.UTF_8.displayName());
    ...
    private String md5(String s) throws UnsupportedEncodingException, NoSuchAlgorithmException {
        ...
        for (int i = 0; i < theDigest.length; ++i) {
            sb.append(Integer.toHexString((theDigest[i] & 0xFF) | 0x100), 1, 3);
        }
        return sb.toString();
