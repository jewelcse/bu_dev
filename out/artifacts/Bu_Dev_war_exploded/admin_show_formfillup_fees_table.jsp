    ...
    <div id="printData">
        ...
        <table class="table table-hover" id="myTable" border="2px solid black">
            ...
            <tr>
                ...
                <td>
                    <a href="adminFeesTableController?type=formfillup_fee&&status=false&&id=<% out.print(allformfillupfee.get(i).getId());%> "><input
                            type="submit" class="btn btn-danger" value="Not-Verify"></a>
                    <a href="adminFeesTableController?type=formfillup_fee&&status=true&&id=<% out.print(allformfillupfee.get(i).getId());%> "><input
