            ...
            <div class="card-body mb-5">
                ...
                <div class="md-form">
                    <label for="semester" class="">Semester</label> <input type="text"
                                                                           ...
                                                                           class="form-control"
                                                                           value="<c:out value="${formfillup_fee.getSemester()}" />"
                                                                           readonly>
                </div>
                <div class="md-form">
                    <label for="main_fee" class="">Main Fee</label> <input type="text"
                                                                           ...
                                                                           class="form-control"
                                                                           value="<c:out value="${formfillup_fee.getMain_fee()}" />"
                                                                           required>
                </div>
                ...
                <div class="md-form mb-2">
                    <label for="date" class="">Start date</label> <input type="date"
                                                                         name="start_date"
                                                                         value="<c:out value="${formfillup_fee.getStart_date()}" />"
                                                                         required>
                </div>
                <div class="md-form mb-2">
                    <label for="date" class="">End date</label> <input type="date"
                                                                       name="end_date"
                                                                       value="<c:out value="${formfillup_fee.getEnd_date()}" />"
                                                                       required>
                </div>
